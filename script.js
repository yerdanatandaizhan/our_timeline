...
const posts = [
  ...
  },
  {
    ...
    description:
      "Первые признаки отдаления от снг?) P/S: эти сборы мне нравились больше, потому что кто-то чаще ходил на эти сборы)",
  ...
  },
  {
    ...
    title: "Лувр🏛️",
    description:
      "Первый совместный аутинг и первый совместный поход в ресторан?) (Возможно кто-то не помнит но в хару мы тогда сидели рядом, да и ресторан выбрали один, как думаешь, совпадение или нет?))",
  ...
  },
  {
    ...
    description:
      "Дэйт который ты организовала) Никогда не забуду, арт выставка, хэликоптер хэликоптер, мамша и живое исполнение I just called...",
  ...
  },
  {
    ...
    title: "Құдашаа💃🕺",
    description:
      "Наш первый совместный танец) Но как же я чуть не проспал из-за концерта, ахахах",
